-- Fixed migration: Add missing columns to existing appointments table
...
-- Service role can do everything (for voice server to write transcripts)
...
-- Patients can view their own data (fixed type casting)
